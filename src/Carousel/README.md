...
### ( TODO: Not yet implemented ) Additional Attributes for when autoplay is set 
...
## ( TODO: Not yet implemented ) Carousel Events
...
### ( TODO: Not yet implemented )  Additional Events for when autoplay is set
...
### ( TODO: Not yet implemented ) Additional Events for touch devices
...
* The `carousel` will manipulate the `tabindex` property of nested focusable elements inside `<li>`.
