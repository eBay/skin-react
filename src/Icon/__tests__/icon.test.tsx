...
describe('Icon', () => {
  it('should render a Icon with .icon', () => {
    const component = shallow(<Icon name="add" a11yText="a11yText" />);
    expect(component.hasClass('icon')).toBe(true);
  });

  it('should render a Icon(span) with .icon--arrow-left and custom classNames', () => {
    const component = shallow(<Icon name="arrow-left" className="custom-class" />);
  ...
  it('should render a Icon(span) with customClassNames', () => {
    const component = shallow(<Icon name="arrow-left" customClassName="custom-class-name" className="custom-class" />);
    expect(component.is('svg')).toBe(true);
