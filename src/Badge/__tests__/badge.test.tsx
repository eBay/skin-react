...
describe('<Badge>', () => {
  it('should not exist', () => {
    const component = mount(<Badge value={0} />);
    expect(component.html()).toBe(null);
  });
  it('renders defaults', () => {
    const component = mount(<Badge value={5} />);
    expect(component.text()).toBe('5');
  });

  it('renders number with rounded-up value', () => {
    const component = mount(<Badge value={5.6} />);
    expect(component.text()).toBe('5');
  });
  ...
  describe('given number is a string', () => {
    ...
    it('renders number with rounded-up string', () => {
      const component = mount(<Badge value="5.4" />);
      expect(component.text()).toBe('5');
    });

    it('does not renders with an invalid string', () => {
      const component = mount(<Badge value="five" />);
      expect(component.html()).toBe(null);
    });
  ...
  it('truncates when the value is greater than 99', () => {
    const component = mount(<Badge value={150} />);
